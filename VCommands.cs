    ...
    public static class VCommands
    {
        ...
        public static string _GetTextCommands()
        {
            return
                ...
                "|findhouse|moveinfromhouse|moveoutfromhouse|hideui|removeallfire|allbulot|forceallmovein|savenpchousehold|loadnpchousehold|looppaa" +
                ...
                "|savealllot|saveallhh|saveallhhandlot|newhhfromah|newhhfromts|savealllotnct|saveallhhnct|installdc|addsimtohousehold/2|fixsimlist" +
                "|randomforcesetaa|ustsimall|delallsim|sdhkeyname|sdsetnamels|cukeyname|mskillah|mskillth|mskillaa|mskillalldesc|mskillts|testdyield" +
                //"|c" +
                //"|c" +
                //"|c" +
                //"|c" +
        ...
        #region Fields
        private static bool checkmkcall = false;
        public static bool looppaabool = false;
        public static ObjectGuid looppaa_01_ObjectID = new ObjectGuid();
...
//#if unusd
            if (Assembly.GetCallingAssembly() == Assembly.GetExecutingAssembly())
            {
                ...
                //ScriptCore.CacheManager.CacheManager_IsCachingAllowed("GameplayData");
                //Comman.Debugger_Break();
                //ulong mSourceDataHash, mSourceDataSize;
                //int mSourceRecordCount;
                //ScriptCore.CacheManager.CacheManager_ReadDatabaseChecksum("GameplayData", out mSourceDataHash, out mSourceDataSize, out mSourceRecordCount);
                //Comman.Debugger_Break();
                //ScriptCore.DownloadContent.DownloadContent_IsDevBuild();
                //Comman.Debugger_Break();
                ...
                var p = GC.MaxGeneration;
                Comman.Debugger_Break();

                GC.InternalCollect(p);
                Comman.Debugger_Break();
...
//#endif
        ...
        public static bool SimCanLearnSkill(SkillNames skillName, SimDescription simDesc)
        {
            ...
            var skill = SkillManager.GetStaticSkill(skillName);
            if (skill == null)
                return false;

            if ((CASUtils.CASAGSAvailabilityFlagsFromCASAgeGenderFlags(CASAgeGenderFlags.Adult | simDesc.Species) & skill.AvailableAgeSpecies) != 0)
                return true;
            if ((CASUtils.CASAGSAvailabilityFlagsFromCASAgeGenderFlags(CASAgeGenderFlags.Teen | simDesc.Species) & skill.AvailableAgeSpecies) != 0)
                return true;
            if ((CASUtils.CASAGSAvailabilityFlagsFromCASAgeGenderFlags(CASAgeGenderFlags.Child | simDesc.Species) & skill.AvailableAgeSpecies) != 0)
                return true;
            if ((CASUtils.CASAGSAvailabilityFlagsFromCASAgeGenderFlags(CASAgeGenderFlags.Toddler | simDesc.Species) & skill.AvailableAgeSpecies) != 0)
                return true;

            return false;
        }

        public static string CustomContext_GetResName(uint resCode)
        {
            //ILocalizationModel localizationModel = Responder.Instance.LocalizationModel;
            switch (resCode)
            {
                case 0u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:Failed");
                case 1u:
                case 2u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:CriticalSystemFailed");
                case 3u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:CASSimImportFailed");
                case 4u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:ReadOnlyMode");
                case 5u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:FileNotExist");
                case 6u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:CanNotOpenFile");
                case 7u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:CanNotOpenPackage");
                case 8u:
                case 10u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:PackageCorrupted");
                case 9u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:PackageNotFound");
                case 11u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:HasDependents");
                case 4096u:
                    if (CommandLine.FindSwitch("ccuninstall") != null)
                    {
                        return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:UninstallSuccess");
                    }
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:Success");
                case 4097u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:NeedsRestart");
                case 15u:
                case 4098u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:PackageAlreadyInstalled");
                case 4099u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:MissingDependancy");
                case 4100u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:MissingPaidContent");
                case 12u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:RequiresMissingEP");
                case 13u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:RequiresGameUpdate");
                case 14u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:RequiresMissingPaidObject");
                case 4101u:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:MissingEPDependency");
                default:
                    return ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString("Ui/Caption/Install:UnknownError");
            }
        }

        public static bool MasterSkill(SimDescription simd, bool yield)
        {
            if (SkillManager.SkillDictionary == null || simd == null || simd.SkillManager == null) 
                return false;

            var skillManager = simd.SkillManager;
            var lookup = new Dictionary<SkillNames, bool>();

            foreach (Skill skill in SkillManager.SkillDictionary)
            {
                if (yield && Simulator.CheckYieldingContext(false))
                    Simulator.Sleep(0);
                ...
                if (!lookup.ContainsKey(skill.Guid))
                {
                    ...
                    if (SimCanLearnSkill(skill.Guid, simd))
                    {
                        var mySkill = skillManager.GetElement(skill.Guid);
                        try
                        {
                            if (mySkill == null)
                        ...
                        {
                            Comman.DPrintException("Add Element Skill Failed\nName: " + simd.FullName, ex);
                            if (skillManager.GetElement(skill.Guid) == null)
                            {
                                mySkill = skillManager.GetStaticSkillClone((ulong)skill.Guid);
                                if (mySkill != null)
                                    skillManager.InternalAddElement(skill.Guid, mySkill);
                            }
                        }
                        ...
                        if (mySkill != null)
                        {
                            try
                            {
                                mySkill.ForceSkillLevelUp(10);
                                mySkill.ChangeSkillProgress(10f);
                                mySkill.AddPoints(1E+19f);
                            }
                            catch (ResetException)
                            { throw; }
                            catch (Exception ex)
                            { Comman.DPrintException("Skill Level Up Failed\nName: " + simd.FullName, ex); }
                        }
                        else
                        {
                            mySkill = skillManager.AddElement(skill.Guid);
        ...
        public static List<SimDescription> CopyAllSimDesc()
        {
            ...
            household.BioText = "Date " + Comman.GetNowTimeToStr();
        ...
        public static string SaveAllSimDesc()
        {
            ...
            Comman.PrintMessage("SaveAllSimDesc\n" + (packageFile ?? "Save Failed"), false, float.MaxValue);
        ...
        public static void test_yield_disable() // Testing x32dbg Debugger 
        {
            // Tested NRaas Failed // caused by 
            /*
            while(true) {
                if (Simulator.CheckYieldingContext()) 
                    Simulator.Sleep(0);
            }
            */
            ...
            if (Comman.GetCurrentExecuteType() != ScriptExecuteType.Task)
                throw new ArgumentException("GetCurrentExecuteType() != ScriptExecuteType.Task");
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    Comman.PrintMessage("test_yield_disable() failed\nPlease read x32dbg log", false, float.MaxValue);
            ...
            Simulator.YieldingDisabled = false;
            Comman.PrintMessage("test_yield_disable() Done\nSafe Others Mod", false, float.MaxValue);
        }
        ...
        public static void UnSafeForceErrorTargetSim(Sim obj_Sim)
        {
            ...
            Simulator.DestroyObject(obj_Sim.mSimUpdateId);
        }
        ...
        public static
            void mskillah_command()
        {
            Household ah = Household.ActiveHousehold;
            if (ah == null) 
                return;

            Comman.Household_RemoveNullForHouseholdMembers(ah);
            foreach (var item in ah.mMembers.mAllSimDescriptions)
            {
                if (item == null) 
                    continue;
                ...
                try
                {
                    MasterSkill(item, true);
                }
                catch (ResetException)
                { throw; }
                catch (Exception ex)
                { Comman.DPrintException("Master Skill failed\nName: " + item.FullName, ex); }
            }
        }

        public static
            void mskillth_command()
        {
            Household household = Comman.GetTargetSimHousehold();
            if (household == null)
                return;

            Comman.Household_RemoveNullForHouseholdMembers(household);
            foreach (var item in household.mMembers.mAllSimDescriptions)
            {
                if (item == null)
                    continue;
        ...
        public static
            void mskillalldesc_command()
        {
            PlumbBob t = PlumbBob.sSingleton;
            PlumbBob.sSingleton = null;

            var relationshipList = Sims3.Gameplay.Socializing.Relationship.sAllRelationships;
            Sims3.Gameplay.Socializing.Relationship.sAllRelationships = new Dictionary<SimDescription, Dictionary<SimDescription, Sims3.Gameplay.Socializing.Relationship>>();

            try
            {
                VoidEventHandler func = mskillalldesc_command_internal;
                if (func == null || func.method_info == null || func.method_ptr == new IntPtr((int)0))
                    return;
            ...
            {
                checkmkcall = false;
                Sims3.Gameplay.Socializing.Relationship.sAllRelationships = relationshipList;
                PlumbBob.sSingleton = t;
            }
        }

       

        internal static void mskillalldesc_command_internal()
        {
            if (Simulator.CheckYieldingContext(false)) 
                return;
            ...
            foreach (var item in Comman.GetAllSimDescription())
            {
                if (item == null || !item.IsValidDescription || item.SkillManager == null)
                    continue;

                try
                {
                    MasterSkill(item, false);
                }
                catch (ResetException)
                { throw; }
                catch (Exception ex)
        ...
        public static
            void mskillaa_command()
        {
            var aa = PlumbBob.SelectedActor;
            if (aa == null)
                return;

            var simd = aa.mSimDescription;
            if (simd == null || simd.SkillManager == null) 
                return;

            MasterSkill(simd, true);
        }

        public static
            void mskillts_command()
        {
        ...
        public static void cukeyname_command()
        {
            ...
            while (true)
            {
                ...
                untranslatedKey = StringInputDialog.Show("Convert Untranslated Key", debug == "" ? "Enter untranslated key:" : debug, untranslatedKey, false, 2048);
                if (string.IsNullOrEmpty(untranslatedKey))
                    break;

                debug = "";
                debug += "Untranslated key: " + untranslatedKey;
                debug += "\n\n-Translated: " + ScriptCore.LocalizedStringService.LocalizedStringService_GetLocalizedStringByString(untranslatedKey ?? "");
        ...
        public static
            void sdhkeyname_command()
        {
            if (ScriptCore.CameraController.Camera_GetTarget() == Vector3.Empty) // if not InWorld()
                return;

            Comman.FixUpHouseholdListObjects(true);

            WorldName worldName = GameUtils.GetCurrentWorld();

            var sStringTable = StringTable.gStringTable;
            StringTable.gStringTable = null;
            ...
            try
            {
                foreach (var item in Comman.GetAllSimDescription())
                {
                    if (item == null)
                        continue;
                    if (item.mHairColors == null || item.mSimDescriptionId == 0 || !item.mIsValidDescription)
                        continue;

                    //item.mFirstName = SimUtils.GetRandomGivenName(item.IsMale, worldName);
                    //item.mLastName = SimUtils.GetRandomFamilyName(worldName);

                    if (item.CreatedByService is GrimReaper || item.Service is GrimReaper)
                    {
                        item.mFirstName = "Gameplay/SimNames/Custom:GrimReaperFirstName";
                        item.mLastName = "Gameplay/SimNames/Custom:GrimReaperLastName";
                    }
                    else if (item.IsBonehilda)
                    {
                        item.mFirstName = "Gameplay/Actors/Sim:BonehildaName";
                        item.mLastName = "";
                    }
                    else if (item.IsPet)
                    {
                        item.mFirstName = Comman.GetUnKeyPetNames
                        (item.IsMale, item.Species, true);

                        item.mLastName = Comman.GetUnKeyPetNames
                        (item.IsMale, item.Species, false);
                    }
                    else if (item.IsMummy)
                    {
                        item.mFirstName = SimUtils.GetRandomMummyGivenName
                        (item.IsMale);

                        item.mLastName = SimUtils.GetRandomMummyFamilyName();
                    }
                    else if (item.IsAlien)
                    {
                        item.mLastName = SimUtils.GetRandomAlienGivenName
                        (item.IsMale);

                        item.mLastName = SimUtils.GetRandomAlienGivenName(item.IsMale);
                    }
                    else if (item.IsFrankenstein || item.IsEP11Bot)
                    {
                        item.mFirstName = SimUtils.GetRandomRobotGivenName
                        (item.IsMale);
                    ...
                    {
                        item.mFirstName = SimUtils.GetRandomGivenName
                        (item.IsMale, item.HomeWorld == WorldName.Undefined ? worldName : item.HomeWorld);

                        item.mLastName = SimUtils.GetRandomFamilyName(item.HomeWorld == WorldName.Undefined ? worldName : item.HomeWorld);
                    }
                }
                ...
                foreach (var item in Comman.SCO_GetObjects<Household>())
                {
                    ...
                    Comman.Household_RemoveNullForHouseholdMembers(item);

                    if (item.mMembers.mAllSimDescriptions.Count == 0)
                        continue;

                    //bool r0 = false;
                    string unName = item == Household.sNpcHousehold || item == Household.sPetHousehold ? null : SimUtils.GetRandomFamilyName(worldName);
                    foreach (var itemMembers in item.mMembers.mAllSimDescriptions)
                    {
                        if (itemMembers == null)
                            continue;
                        ...
                        //{
                        //    r0 = true;
                        //    item.mName = itemMembers.mLastName;
                        //}

                        if (itemMembers.CreatedByService is GrimReaper || itemMembers.Service is GrimReaper)
                        {
                            itemMembers.mFirstName = "Gameplay/SimNames/Custom:GrimReaperFirstName";
                            itemMembers.mLastName = "Gameplay/SimNames/Custom:GrimReaperLastName";
                        }
                        else if (itemMembers.IsBonehilda)
                        {
                            itemMembers.mFirstName = "Gameplay/Actors/Sim:BonehildaName";
                            itemMembers.mLastName = "";
                        }
                        else if (itemMembers.IsPet)
                        {
                            itemMembers.mFirstName = Comman.GetUnKeyPetNames
                            (itemMembers.IsMale, itemMembers.Species, true);

                            itemMembers.mLastName = Comman.GetUnKeyPetNames
                            (itemMembers.IsMale, itemMembers.Species, false);
                        }
                        else if (itemMembers.IsMummy)
                        {
                            itemMembers.mFirstName = SimUtils.GetRandomMummyGivenName
                            (itemMembers.IsMale);

                            itemMembers.mLastName = unName ?? SimUtils.GetRandomMummyFamilyName();
                        }
                        else if (itemMembers.IsAlien)
                        {
                            itemMembers.mLastName = SimUtils.GetRandomAlienGivenName
                            (itemMembers.IsMale);

                            itemMembers.mLastName = unName ?? SimUtils.GetRandomAlienGivenName(itemMembers.IsMale);
                        }
                        else if (itemMembers.IsFrankenstein || itemMembers.IsEP11Bot)
                        {
                            itemMembers.mFirstName = SimUtils.GetRandomRobotGivenName
                            (itemMembers.IsMale);

                            if (itemMembers.IsEP11Bot)
                                itemMembers.mLastName = "";
                            else 
                                itemMembers.mLastName = unName ?? "";
                        }
                        else
                        {
                            itemMembers.mFirstName = SimUtils.GetRandomGivenName
                            (itemMembers.IsMale, itemMembers.HomeWorld == WorldName.Undefined ? worldName : itemMembers.HomeWorld);

                            itemMembers.mLastName = unName ?? SimUtils.GetRandomFamilyName(itemMembers.HomeWorld == WorldName.Undefined ? worldName : itemMembers.HomeWorld);
                        }
                    }
            ...
            StringTable.gStringTable = sStringTable;

            foreach (var item in Comman.GetAllSimDescription())
            {
                if (item == null)// || item.mGenealogy == null)
                    continue;
                //item.mGenealogy.Name = item.FullName;
                item.FirstName = item.mFirstName;
                item.LastName = item.mLastName;
            }
            ...
            foreach (var item in Comman.SCO_GetObjects<Household>())
            {
                ...
                foreach (var itemMembers in item.mMembers.mAllSimDescriptions)
                {
                    ...
                    itemMembers.FirstName = itemMembers.mFirstName;
                    itemMembers.LastName = itemMembers.mLastName;
                }
            }
        }

        public static
            void sdsetnamels_command()
        {
            if (ScriptCore.CameraController.Camera_GetTarget() == Vector3.Empty) // if not InWorld()
                return;
            ...
            foreach (var item in Comman.GetAllSimDescription())
            {
                ...
                //item.mFirstName = item.FirstName;
                //item.mLastName = item.LastName;
                //
            ...
            foreach (var item in Comman.SCO_GetObjects<Household>())
            {
                ...
                foreach (var itemMembers in item.mMembers.mAllSimDescriptions)
                {
                    ...
                    itemMembers.FirstName = itemMembers.FirstName;
                    itemMembers.LastName  = itemMembers.LastName;
                }
            }
        }
        ...
        {
            Sim targetSim = Comman.GetTargetGameObject() as Sim;
            if (targetSim != null && !Comman.FixUpPlumbBobSingletonNull())
                return;
            ...
            bool forcesetaa3_command(Sim sim, bool noDialog)
        {
            if (PlumbBob.sSingleton == null)
            {
                if (sim != null && sim.Proxy != null && Comman.FixUpPlumbBobSingletonNull()) { }
                else return false;
            }
            ...
            if (hoc != null)
            {
                ...
                if (mhouse != null)
                {
                    ...
                    try
                    {
                        ...
                        mhouse.Name = "World/Household:ServiceNpcFamilyName";
                    }
                    catch (Exception ex)
                    { Comman.PrintException(null, ex); }
                    try
                    ...
                    foreach (var item in Household.sNpcHousehold.AllSimDescriptions.ToArray())
                    {
                        ...
                        if (found)
                        {
                            ...
                            Comman.PrintMessage("Name: " + item.FirstName + "\nServiceType Bio: " + item.mBio, false, 100);
                        ...
                        foreach (var item in nofoundList.ToArray())
                        {
                            try
                            {
                               // nofoundList_householdNew.AddTemporary(item);
                                Comman.Household_Add(nofoundList_householdNew, item, true);
                            }
                            catch (Exception)
                            {}
                        }
            ...
            void savenpchousehold_command()
        {
            ...
            Comman.Household_RemoveNullForHouseholdMembers(npc);
            try
            {
            ...
            void installdc_command()
        {
            ...
            try 
            {
                ...
                if (errorCode == 4096u || errorCode == 4098u)
                {
                    PackageId pID = default(PackageId);
                    ScriptCore.DownloadContent.DownloadContent_GetFirstPackageId(ref pID);
                    if (pID.mPart0 != 0 && pID.mPart1 != 0)
                    {
                        Comman.PrintMessage("PackageID\nPart00: 0x" + pID.mPart0.ToString("X") + "\nPart01: 0x" + pID.mPart1.ToString("X"), false, float.MaxValue);
                        ScriptCore.DownloadContent.DownloadContent_SetPackageEnabledImpl(pID, true);
                    }
                    else
                    {
                        DEBUG_Utils.Print("if (pID.mPart0 != 0 && pID.mPart1 != 0) failed.");
                    }
                }
                if (isInited)
                {
            ...
            var str = CustomContext_GetResName(errorCode);
            if (str.Length == 0)
                str = errorCode.ToString();

            Comman.PrintMessage("Install CustomContext\nErrorCode: " + str, false, float.MaxValue);
        }
        ...
        {
            foreach (var objSim in Comman.SCO_GetObjects<Sim>())
            {
                UnSafeForceErrorTargetSim(objSim);
            }
        }
                    ...
                    if (done)
                    {
                        if (GameStates.IsLiveState && PlumbBob.SelectedActor == null && lotHousehold.mMembers.mAllSimDescriptions.Count > 0 && lotHousehold.mMembers.ActorList.Count > 0 && !ScriptCore.World.World_IsEditInGameFromWBModeImpl() && Simulator.CheckYieldingContext(false))
                        {
                            ...
                            if (AcceptCancelDialog.Show("Do you set Active Sim?" + (sim == null ? "\nCould not find Household Members!" : "\nName: " + sim.Name)))
                            {
                                ...
                                if (!PlumbBob.ForceSelectActor(sim))
                                {
                                    PlumbBob.sSingleton.mSelectedActor = sim;
                                    PlumbBob.sCurrentNonNullHousehold = sim.Household;

                                    Comman.Household_RefrashAllActors(sim.Household);
        ...
        public static
            bool randomforcesetaa_command()
        {
            Simulator.CheckYieldingContext(true);
            if (GameStates.IsLiveState && ScriptCore.CameraController.Camera_GetPosition() != Vector3.Empty && !looppaabool && PlumbBob.SelectedActor == null)
            {
                if (!Comman.FixUpPlumbBobSingletonNull())
                    return false;
                ...
                foreach (var item in Comman.SCO_GetObjects<Sim>())
                {
                    ...
                    if (simd == null || simd.mSim != item)
                        continue;

                    var household = simd.Household;
                    if (household == null || Comman.Household_IsSpecialHousehold(household)) 
                        continue;

                    var name = simd.FullName;
                    var householdName = household.Name;
                    var age = simd.Age;
                    var gender = simd.Gender;
                    var species = simd.Species;

                    var info = "Name: " + name + "\n" +
                               "Household Name: " + (householdName == null || householdName.Length == 0 ? "No Name" : householdName) + "\n" +
                               "Age: " + age + "\n" +
                               "Gender: " + gender + "\n" +
                               "Species: " + species;

                    r:switch (ThreeButtonDialog.Show(info, "Yes", "Next", "More"))
                    {
                        case ThreeButtonDialog.ButtonPressed.FirstButton:
                            TestSetActiveActor(item);
                        ...
                        case ThreeButtonDialog.ButtonPressed.ThirdButton:
                            if (AcceptCancelDialog.Show("Accept: Household Info\nCancel: Exit"))
                            {
                                SimpleMessageDialog.Show("Household", DEBUG_Utils.GetHouseholdInfo(household, false, null) ?? "Should Veitc Bug");
                                goto r;
                            }
                            else return false;
                    }
            ...
            void rallg_command()
        {
            ...
            {
                sleep++;
                if (sleep > 150) { sleep = 0; Simulator.Sleep(0); }
        ...
        {
            if (looppaa_01_ObjectID == ObjectGuid.InvalidObjectGuid)
            {
                looppaa_01_ObjectID = Comman.CreateThread(ScriptExecuteType.Task,delegate
                {
                    Sim activeActor = PlumbBob.SelectedActor;
                    ...
                    try
                    {
                        while (PlumbBob.Singleton != null)
                        {
                            ...
                            PlumbBob.Singleton.mSelectedActor = ((activeActor != null) ?
                                    Comman.GetRandomSim((Sim test) => test != null && test.Household != activeActor.Household) :
                                Comman.GetRandomSim(null)) ?? PlumbBob.Singleton.mSelectedActor;
                    ...
                    {
                        looppaabool = false;
                        looppaa_01_ObjectID = new ObjectGuid(0);
                ...
                Comman.RemoveTaskFromSimulator(ref looppaa_01_ObjectID);
        }
            ...
            if (lot != null && !(lot is WorldLot))
            {
                if (lot.Household == null)
                {
                    ...
                    if (hoc != null)
                    {
                        ...
                        if (hocCount > 0 && hoc.mMembers.ActorList.Count > 0 && !ScriptCore.World.World_IsEditInGameFromWBModeImpl() && GameStates.IsLiveState && PlumbBob.SelectedActor == null && Comman.FixUpPlumbBobSingletonNull() && Simulator.CheckYieldingContext(false) && AcceptCancelDialog.Show("Force Set Active Actor?"))
                        {
                ...
                else
                {
                    if (AcceptCancelDialog.Show("Merge Household?"))
                    {
                        ...
                        if (householdImported != null)
                        {
                            ...
                            if (GameStates.IsLiveState && PlumbBob.SelectedActor == null && lotHousehold.mMembers.mAllSimDescriptions.Count > 0 && lotHousehold.mMembers.ActorList.Count > 0 && !ScriptCore.World.World_IsEditInGameFromWBModeImpl() && Comman.FixUpPlumbBobSingletonNull() && Simulator.CheckYieldingContext(false) && AcceptCancelDialog.Show("Force Set Active Actor?"))
                            {
        ...
        public static void _RunCommands(object[] parameters)
        {
            if (parameters != null && parameters.Length > 0 && (parameters[0] is string))
            {
                ...
                else if (temp == "sdsetnamels") { sdsetnamels_command(); }
                ...
                else if (temp == "mskillah")
                {
                    mskillah_command();
                }
                else if (temp == "mskillth")
                {
                    mskillth_command();
                }
                else if (temp == "mskillalldesc")
                {
                    mskillalldesc_command();
                }
                else if (temp == "mskillaa")
                {
                    mskillaa_command();
                }
                ...
                else if (temp == "randomforcesetaa")
                {
                    randomforcesetaa_command();
                }
